...
public class Valores {
    ...
    public Valores(ScrollingConsumptionActivity consumo, String ip, String menu) {
        this.consumo = consumo;
        this.ip = ip;
        this.menu = menu;
    }

    public Valores(ScrollingConfigurationActivity configuracion, String ip, String menu) {
        this.configuracion = configuracion;
        this.ip = ip;
        this.menu = menu;
    }

    public Valores(double valorkwh, double valortransporte, int valoradministracion) {
        this.valorkwh = valorkwh;
        this.valortransporte = valortransporte;
        this.valoradministracion = valoradministracion;
    }
